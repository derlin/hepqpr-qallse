...
def run_experiment():
    ...
    for i in range(num_repeats):
        ...
        with stdout_redirect(f'qbsolv_{i}-{random_seed}.log'):
        ...
        # dump all to file
        with open(f'qbsolv_response_{i}-{random_seed}.pickle', 'wb') as f: pickle.dump(response, f)
        with open(f'final_tracks_doublets_{i}-{random_seed}.pickle', 'wb') as f: pickle.dump((final_tracks, final_doublets), f)
